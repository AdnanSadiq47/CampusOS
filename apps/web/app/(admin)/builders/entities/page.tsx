  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Dynamic Entity & Virtual ORM Builder</h2>
          <p className="text-sm text-slate-500">
            Define custom data models, typed attributes, and relational integrity rules without touching database DDL.
          </p>
        </div>
